...
public class DataGenerator {
	...
	public static void generateProducts(){
		...
		ElektronikUrunleri eUrun2 = new ElektronikUrunleri("Telefon",10000d,"Aciklama",EKategori.ELEKTRONIK, 3,24,4d,
		                                                   ECihazTipi.TELEFON);
		...
		AksesuarUrunleri aksesuar4 = new AksesuarUrunleri("Yuzuk", 250d, "Gumus bir yuzuk. Zarif bir cizgili desenle suslenmi�.", EKategori.AKSESUAR, 4, ETur.YUZUK, EMateryal.GUMUS, EDesen.CIZGILI);
