...
//        nameDeque.add("Mehmet Can");
		...
		System.out.println(nameDeque);
		//Listenin sonuna ulaþýldýðýnda (eleman kalmadýðýnda null döner.)
		nameDeque.poll();
		//Listenin sonuna ulaþýldýðýnda (gezecek eleman kalmadýðýnda NoSuchElementException hatasi firlatir)
		nameDeque.pop();
