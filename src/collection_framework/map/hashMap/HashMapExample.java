...
public class HashMapExample {
	public static void main(String[] args) {
		...
		String value = languageHashMap.getOrDefault(4,"Not found");
		...
		System.out.println(languageHashMap.containsKey(2));
		...
		System.out.println("key value pair'ı dogru bir sekilde verildiginde siler ve true doner. Aksi takdirde silme " +
				                   "islemi gerceklesmez, false doner.");
