...
public class LinkedHashSetExample {
	public static void main(String[] args) {
		...
		sayiLinkedHashSet.addAll(Set.of(1,-10,20,30,3,-13,100,60,-6));
		...
		System.out.println();
		System.out.println("\n1,-10,20,30,3,-13,100,60,-6");
		sayiLinkedHashSetWithList.addAll(List.of(1,-10,20,30,3,-13,100,60,-6,-6));
		System.out.println("LinkedHashSetWithListOf: "+sayiLinkedHashSetWithList);
