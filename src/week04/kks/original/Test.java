...
//        arrayList2.add(integer);
		...
		// Message turunde mail1 degiskeninin, Message() constructoru ile bir instance'ýný olusturduk.
		
		Message mail2 = new Mail();
		//Message davranislarini ve ozelliklerini alir, ancak potansiyelde Mail ozelliklerini de edinebilir.
		// Message turunde mail2 degiskeninin, Mail() constructoru ile bir instance'ýný olusturduk.
